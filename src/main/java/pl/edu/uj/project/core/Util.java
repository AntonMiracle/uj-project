...
public class Util {
    ...
    public static void throwIAE(boolean whenTrue, Object classWhereIAE, String methodName, String withMsg) {
    ...
    public static void throwIAEWhenNull(Object object, Object classWhereIAE, String methodName) {
        String msg = createName(classWhereIAE, methodName) + " : Argument is NULL";
        if (object == null) throw new IllegalArgumentException(msg);
    }

    private static String createName(Object classWhereIAE, String methodName) {
